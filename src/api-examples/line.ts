...
export class Game extends Juno.Game {
  ...
  render(): void {
    ...
    for (let i = this.t % 8; i <= 63; i = i + 8) {
      this.graphics.line(i, 0, 0, 63 - i, 8);
      this.graphics.line(i, 63, 63, 63 - i, 6);
      this.t = this.t + 0.02;
    }
    ...
    for (let i = (this.t / 16) % this.pi8; i <= this.pi2; i += this.pi8) {
      ...
      this.graphics.line(63, 0, x, y, 15);
      this.graphics.line(0, 63, x, y, 15);
    }

    this.graphics.line(0, 0, 63, 0, 8);
    this.graphics.line(0, 0, 0, 63, 8);
    this.graphics.line(63, 0, 63, 63, 6);
    this.graphics.line(0, 63, 63, 63, 6);
  }
}
